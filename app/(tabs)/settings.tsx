    ...
    <>
      ...
      <View style={styles.container}>
        <TouchableOpacity style={styles.itemBtn}>
          ...
          <MaterialIcons name="arrow-forward-ios" size={16} color={"red"} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.itemBtn}>
        ...
        <TouchableOpacity style={styles.itemBtn}>
          <Text style={[styles.itemBtnText]}>Term of Use</Text>
          <MaterialIcons name="arrow-forward-ios" size={16} color={"red"} />
        </TouchableOpacity>
        <TouchableOpacity onPress={toggleSwitch} style={styles.itemBtn}>
